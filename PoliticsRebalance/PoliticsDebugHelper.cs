...
namespace AllegianceOverhaul.PoliticsRebalance
{
  ...
  {
    private const string OutcomeIsAbstain = "{=}They chose not to bring this matter to the royal court.";
    private const string OutcomeIsElectionStart = "{=}They chose to initiate new kingdom election on this matter.";

    private const string PossibleActionMakingPeace = "{=}are in the good mood and would like to make peace with someone";
    private const string PossibleActionDeclaringWar = "{=}are in the bad mood and would like to declare war on someone";
    private const string PossibleActionChangingKingdomPolicy = "{=}are in the worries about the fates of the kingdom and would like to change some of its policies";
    private const string PossibleActionAnnexingFief = "{=}are vaguely feel a certain injustice in the current assignment of kingdom lands and would like to redistribute some fiefs";

    private const string ActionMakingPeace = "{=}making peace with";
    private const string ActionDeclaringWar = "{=}declaring war on";
    private const string ActionIntroducingKingdomPolicy = "{=}introducing a new policy of";
    private const string ActionDisavowingKingdomPolicy = "{=}disavowing the policy of";
    private const string ActionAnnexingFief = "{=}annexing {?ANNEXED_SETTLEMENT.IS_TOWN}town of{?}{?ANNEXED_SETTLEMENT.IS_VILLAGE}village of{?}{\\?}{\\?}";

    private const string AnnexingFiefActionDetails = "{=} from {ANNEXED_SETTLEMENT_CLAN.NAME}";
